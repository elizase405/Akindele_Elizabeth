            ...
            <div className='h-[300vh] bg-[#ECE5D7] flex justify-end gap-2' ref={fwRef}>
                <div className="sticky top-0 flex h-[15%] sm:h-screen items-center justify-center overflow-hidden" style={{ WebkitMaskImage: "linear-gradient(to bottom, transparent, black 30%, black 70%, transparent)", maskImage: "linear-gradient(to bottom, transparent, black 30%, black 70%, transparent)"}}>
                    <motion.div className="flex items-center gap-6 sm:gap-12" style={{ x: smoothX }}>
                        ...
                        <motion.div className='relative w-[20rem] h-[20rem] sm:w-[30rem] sm:h-[30rem] overflow-hidden bg-blue-200'>
                                <Link href="https://discover-tan.vercel.app/" target='_blank'>
                ...
                <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden" style={{ WebkitMaskImage: "linear-gradient(to bottom, transparent, black 30%, black 70%, transparent)", maskImage: "linear-gradient(to bottom, transparent, black 30%, black 70%, transparent)"}}>
                    <motion.div className="flex items-center gap-6 sm:gap-12" style={{ x: OPSmoothX }}>
                        <motion.div className='relative w-[20rem] h-[20rem] sm:w-[30rem] sm:h-[30rem] overflow-hidden bg-blue-200'  style={{ rotate: OPR1 }}>
                                <Link href="/">
                                    <Image src={chatio} width={600} height={1200} alt="" className='absolute w-[90%] h-[60%] object-cover rounded-2xl self-center inset-0 z-0 transition-transform duration-300 hover:scale-110 mx-auto mt-4' />
                                </Link>
                        ...
                        <motion.div className='relative w-[20rem] h-[20rem] sm:w-[30rem] sm:h-[30rem] overflow-hidden bg-blue-200'  style={{ rotate: OPR2 }}>
                                <Link href="/">
                                    <Image src={homii} width={600} height={1200} alt="" className='absolute w-[90%] h-[60%] object-cover rounded-2xl self-center inset-0 z-0 transition-transform duration-300 hover:scale-110 mx-auto mt-4' />
                                </Link>
                        ...
                        <motion.div className='relative w-[20rem] h-[20rem] sm:w-[30rem] sm:h-[30rem] overflow-hidden bg-blue-200'  style={{ rotate: OPR3 }}>
                                <Link href="/">
                                    <Image src={trustlens} width={600} height={1200} alt="" className='absolute w-[90%] h-[60%] object-cover rounded-2xl self-center inset-0 z-0 transition-transform duration-300 hover:scale-110 mx-auto mt-4' />
